...
func (s *instrumentingService) LoadCargo(id cargo.TrackingID) (c CargoView, err error) {
	defer func(begin time.Time) {
...
func (s *instrumentingService) Cargos() []CargoView {
	defer func(begin time.Time) {
...
func (s *instrumentingService) Locations() []LocationView {
	defer func(begin time.Time) {
