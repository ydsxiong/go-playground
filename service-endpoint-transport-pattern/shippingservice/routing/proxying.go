...
func makeFetchRoutesEndpoint(ctx context.Context, instance string) endpoint.Endpoint {
	...
	return kithttp.NewClient(
		"GET", u,
		prepareFetchRoutesRequest,
		processFetchRoutesResponse,
	).Endpoint()
}

func prepareFetchRoutesRequest(_ context.Context, r *http.Request, request interface{}) error {
...
func processFetchRoutesResponse(_ context.Context, resp *http.Response) (interface{}, error) {
