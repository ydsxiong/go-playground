...
// expected serviceendpoint middlewares via the various parameters.
func New(svc service.AddService, logger log.Logger, duration metrics.Histogram, otTracer stdopentracing.Tracer, zipkinTracer *stdzipkin.Tracer) Set {
...
// MakeSumEndpoint constructs a Sum serviceendpoint wrapping the service.
...
// MakeConcatEndpoint constructs a Concat serviceendpoint wrapping the service.
...
// compile time assertions for our response types implementing serviceendpoint.Failer.
var (
...
// Failed implements serviceendpoint.Failer.
